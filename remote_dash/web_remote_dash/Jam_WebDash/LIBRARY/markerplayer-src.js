...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.L = global.L || {}, global.L));
})(this, (function (exports, leafletSrc_esm_js) { 'use strict';

    const MarkerPlayer = leafletSrc_esm_js.Marker.extend({
        //state constants
        statics: {
            notStartedState: 0,
            endedState: 1,
        ...
        initialize(points, duration, options) {
            leafletSrc_esm_js.Marker.prototype.initialize.call(this, points[0].latlng, options);
            this._points = points;
        ...
        resume() {
            ...
            if (!this._progChanged) {
                ...
                this._currentLine[0] = Object.assign(Object.assign({}, this._points[this._currentIndex]), { latlng: this.getLatLng() });
        ...
        moveTo(point, duration) {
            this._stopAnimation();
            this._points = [Object.assign(Object.assign({}, this._points[this._currentIndex]), { latlng: this.getLatLng() }), point];
            this._durations = [duration];
            this._state = MarkerPlayer.notStartedState;
            this.start();
        ...
        onAdd(map) {
            leafletSrc_esm_js.Marker.prototype.onAdd.call(this, map);
        ...
        onRemove(map) {
            leafletSrc_esm_js.Marker.prototype.onRemove.call(this, map);
            this._stopAnimation();
        },
        ...
        getProgress(timeFormat = false) {
            ...
            if (this._durations[indx]) { //in case the p1 = p2 : this._durations[indx] = 0
                ...
                let ratio = this.getLatLng().distanceTo(p1) / leafletSrc_esm_js.latLng(p1).distanceTo(p2);
        ...
        _createDurations(points, duration) {
            ...
            for (let i = 0; i < lastIndex; i++) {
                distance = leafletSrc_esm_js.latLng(points[i + 1].latlng).distanceTo(points[i].latlng);
        ...
        _interpolatePosition(p1, p2, duration, t) {
            ...
            r = (r > 0) ? r : 0;
            r = (r > 1) ? 1 : r;
            return leafletSrc_esm_js.latLng(p1.lat + r * (p2.lat - p1.lat), p1.lng + r * (p2.lng - p1.lng));
        },
        _startAnimation() {
            this._state = MarkerPlayer.runState;
            this._progChanged = false; //imoortant so it run by default
            this._animId = leafletSrc_esm_js.Util.requestAnimFrame(function (timestamp) {
        ...
        _stopAnimation() {
            if (this._animRequested) {
                leafletSrc_esm_js.Util.cancelAnimFrame(this._animId);
                this._animRequested = false;
            }
        },
        _updatePosition() {
        ...
        _animate(timestamp, noRequestAnim) {
            ...
            if (elapsedTime != null) {
                ...
                let p = this._interpolatePosition(leafletSrc_esm_js.latLng(this._currentLine[0].latlng), leafletSrc_esm_js.latLng(this._currentLine[1].latlng), this._currentDuration, elapsedTime);
                this.setLatLng(p);
            }
            if (!noRequestAnim) {
                this._animRequested = true;
                this._animId = leafletSrc_esm_js.Util.requestAnimFrame(this._animate, this, false);
            }
        },
    });
    ...
    exports.MarkerPlayer = MarkerPlayer;
    exports.markerPlayer = markerPlayer;

}));
//# sourceMappingURL=markerplayer-src.js.map
